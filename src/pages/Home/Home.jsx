            ...
            <div className='careers flex flex-wrap justify-between gap-6 pt-10'>
              {
                careers && careers.map(career => {
                  return (
                    <div className='career sm:max-w-[48%] md:max-w-[31%] w-full flex flex-col items-center hover:shadow-xl p-3 rounded-xl' key={career.id}>
                  ...
                  return (
                    <div className='career flex items-center gap-6 lg:gap-12 justify-start flex-col md:flex-row' key={career.id}>
                      ...
                      <div className='w-full sm:max-w-[40%] text-center md:text-left'>
                        <h3 className='font-bold text-2xl md:text-3xl'>{career.title}</h3>
                        <p className='mt-5 md:mt-7'>{career.desc}</p>
                      </div>
                    </div>
                  )
                })
